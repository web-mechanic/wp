    ...
    <?php if (have_posts()) : ?>
      <?php while (have_posts()) : the_post(); ?>
        <div class="contentwrapWork" >
          <article class="artpage" role="article" itemscope="" itemtype="http://schema.org/CreativeWork">
            <header>
              <hgroup>
               <h1 class="arttitle" itemprop="name"><span class="dotOrange">.</span> <?php the_title(); ?></h1>
